...
namespace GraphicsLabor.Scripts.Core.Settings
{
    ...
    public class GraphicsLaborSettings : ScriptableObject
    {
        ...
        [Label("Tags Path")] public string _tagsPath = "Assets/GraphicsLabor/Generated"; // For now let it be default, will see if there is any use to modifying its location
