...
namespace NodeSystem.Runtime.NodesLibrary
{
    ...
    {
        [FormerlySerializedAs("logMessage")] [ExposedProperty(portDirection: PropPortDirection.Input, preferredLocation: PropContainerLocation.InputContainer, portType: typeof(string))]
