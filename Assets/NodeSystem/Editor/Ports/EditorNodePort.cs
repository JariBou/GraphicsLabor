...
namespace NodeSystem.Editor.Ports
{
    public class EditorNodePort : Port
    {
        ...
        public static EditorNodePort Create(Orientation orientation,
                                            Direction direction,
                                            Capacity capacity,
                                            Type type)
        {
        ...
        public new static EditorNodePort Create<TEdge>(Orientation orientation,
                                                       Direction direction,
                                                       Capacity capacity,
                                                       Type type)
        ...
        {
            if (!HideWhenConnected || contentContainer.childCount <= 2) return;
